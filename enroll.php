...
<body>
    ...
    <!-- ========================= Hero section start ========================= -->
    <section class=" enroll-banner ptb-200 mt-80">
        <div class="container">
            <div class="row text-center">
                <div class="col-12">
                    <h2 class=" text-white fw-bold ">Enroll</h2>
    ...
    <!-- ========================= Quote section start ========================= -->
    <section class="enroll-quote-area pt-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="enroll-quote-image"></div>
                </div>
                <div class="col-lg-6">
                    <div class="enroll-quote-item">
                        <div class="content">
                        ...
                        <form>
                            ...
                            <button type="submit" class="btn w-100">Submit Now</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <section class="entollment-area ptb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
