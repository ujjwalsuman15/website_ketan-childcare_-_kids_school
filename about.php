...
<body>
    ...
    <!-- ========================= Hero section start ========================= -->
    <section class=" about-banner ptb-200">
        <div class="container">
    ...
    <!-- ========================= Fun-Fact-Area section start ========================= -->
    <section class="fun-fact-area pt-100 pb-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6" data-aos="flip-left" data-aos-easing="ease-out-cubic"
    ...
    <!-- ========================= /Fun-Fact-Area section end ========================= -->

    <!-- ========================= Expert-Teacher section start ========================= -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-6" data-aos="fade-right" data-aos-offset="300"
                    ...
                    <div class="expert-teacher-content">
                        ...
                        <h3 class=" my-3">
                            <a href="about.php" class="fs-2 fw-bold">
                                Our Online Instructor
                            </a>
                        </h3>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut
                        ...
                        <div>
                            <a href="javascript:void()" class="btn my-3">Instructor Profile</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                    ...
                    <div class="expert-teacher-image overflow-hidden position-relative text-center">
                        ...
                        <div class="teacher-content">
                            <h3 class="text-white fw-bold">Glims Bond</h3>
                            <span class="text-white fw-bold">Music Teacher</span>
                            <div class="expert-teacher-social-link">
    ...
    <section class="testimonial ptb-100 position-relative bg-light-red-orange">
                        ...
                        <div class="col-lg-8" data-aos="fade-right" data-aos-offset="300"
                            ...
                            <div class="feedback-content text-start px-3">
                                ...
                                <div class="feedback-info">
                                    <h3 class="fs-3 fw-bold mb-2">Jenya Lisa</h3>
                                    <span class="fs-6">Chairman of Trustee Board</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="pricing ptb-100">
        <div class="container">
            ...
            <div class="table-title mt-3 text-center">
